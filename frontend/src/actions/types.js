...
export const FETCH_CHARTGROUPS_REQUEST = 'FETCH_CHARTGROUPS_REQUEST';
export const FETCH_CHARTGROUPS_SUCCESS = 'FETCH_CHARTGROUPS_SUCCESS';
export const FETCH_CHARTGROUPS_FAILURE = 'FETCH_CHARTGROUPS_FAILURE';
export const SET_SELECTED_CHARTGROUP = 'SET_SELECTED_CHARTGROUP'

export const FETCH_CHARTS_REQUEST = 'FETCH_CHARTS_REQUEST';
export const FETCH_CHARTS_SUCCESS = 'FETCH_CHARTS_SUCCESS';
export const FETCH_CHARTS_FAILURE = 'FETCH_CHARTS_FAILURE';


export const ADD_NEW_QRCODE = 'ADD_NEW_QRCODE';
export const CLEAR_ALL_QRCODE = 'CLEAR_ALL_QRCODE';